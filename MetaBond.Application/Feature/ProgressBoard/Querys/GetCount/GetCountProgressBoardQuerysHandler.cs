...
namespace MetaBond.Application.Feature.ProgressBoard.Querys.GetCount
{
    internal sealed class GetCountProgressBoardQuerysHandler : IQueryHandler<GetCountProgressBoardQuerys, int>
    {
        ...
        public async Task<ResultT<int>> Handle(
            GetCountProgressBoardQuerys request, 
